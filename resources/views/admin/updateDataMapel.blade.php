            ...
            <div class="row mb-2">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" name="kode_mapel" id="kode_mapel" type="text" value="{{ $data->kode_mapel }}" >
            ...
            <div class="row mb-2">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control" name="nama_mapel" id="nama_mapel" type="text" value="{{ $data->nama_mapel }}">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input  class="form-control" name="tingkat_mapel" id="tingkat_mapel" type="text" value="{{ $data->tingkat_mapel }}">
