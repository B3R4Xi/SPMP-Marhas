...
class CreateTblTeach extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_teach', function (Blueprint $table) {
            ...
            $table->foreign('id_mapel')->references('id_mapel')->on('tbl_mapel')->OnUpdate('CASECADE')->OnDelete('CASECADE');
            $table->foreign('id_guru')->references('id')->on('tbl_guru')->OnUpdate('CASECADE')->OnDelete('CASECADE');
            $table->foreign('id_kelas')->references('id')->on('tbl_kelas')->OnUpdate('CASECADE')->OnDelete('CASECADE');
        });
    }
